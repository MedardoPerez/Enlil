...
using SmartH.Models.Infraestructura.Core;
using SmartH.Models.Infraestructura.Repositorios;

namespace SmartH.Models.Infraestructura
{
public class BCUnitOfWork : DbContext
    {
        ...
        public virtual void Commit(Transaction transaction)
        {
            ...
            try
            {
                ...
                using (var scope = TransactionScopeFactory.GetTransactionScope())
                {
                    ...
                    // IEnumerable<DbEntityEntry> changedDbEntityEntries = System.Data.Entity.GetChangedDbEntityEntries();
        ...
        //         e =>
        //         e.Entity is Entity &&
        //         (e.State == System.Data.Entity.EntityState.Modified || e.State == EntityState.Added || e.State == EntityState.Deleted));
        // }
                                                      ...
                                                      Transaction transaction, out string sqlInsert, out object[] objects)
        {
            ...
            int index = 0;
            IEnumerable<string> propertyNames = entry.State == System.Data.Entity.EntityState.Deleted
        ...
        private object GetEntityPropertyValue(DbEntityEntry entry, string prop, Transaction transaction)
        {
            ...
            if (entry.State == System.Data.Entity.EntityState.Deleted || entry.State == System.Data.Entity.EntityState.Detached)
            {
